...
MPII_TO_H36M_PERM = np.array([MPII_NAMES.index(h) for h in H36M_NAMES if h != '' and h in MPII_NAMES])
...
class JointDataset(Dataset):
    def __init__(self, cfg, root, image_set, is_train, always_flip=False):
        ...
        self.rect_3d_width = cfg.DATASET.RECT_WIDTH
        self.rect_3d_height = cfg.DATASET.RECT_HEIGHT
